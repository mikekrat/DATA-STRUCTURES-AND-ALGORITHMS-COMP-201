...
public class BSTDynamic {
     ...
     *  @version https://www.geeksforgeeks.org/binary-search-tree-set-2-delete/?ref=lbp
     */
    public Node deleteRec(Node root, int key) 
    { 
        /* Base Case: If the tree is empty */
        if (root == null & ++comparisonCounter>0)  return root; 
        ...
        { 
            ...
            if (root.left == null & ++comparisonCounter>0) 
                return root.right; 
            else if (root.right == null & ++comparisonCounter>0) 
                return root.left; 
    ...
    /**
     * This method calculates the smallest key from the given root
     * @param root
     * @version https://www.geeksforgeeks.org/binary-search-tree-set-2-delete/?ref=lbp
    ...
    { 
        int minv = root.key; 
        ++comparisonCounter;
        while (root.left != null & ++comparisonCounter>0) 
        { 
            minv = root.left.key; 
            root = root.left; 
            comparisonCounter += 2;
